...
class CPU:
    ...
    def load_num(self, long_num):
        """parse a number into memory as a program."""

        try:
            address = 0

            array = str(long_num).split("2")
    ...
    def run(self):
        ...
        while not self.flags & 0b10000000:
            ...
            if self.pc in disp_table:
                ...
                print(f"ERROR: Unrecognized command {self.pc} at location {self.ir}.")
